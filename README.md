...
As github has file size limiting to less than 25Mb, the spatial snRNA-seq raw count from SpaceRanger (*.h5) is made available via SCP portal under _Miscellaneous_.
